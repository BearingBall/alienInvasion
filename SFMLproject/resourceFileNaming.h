...
public:
	...
	inline static const std::string hero0Name = "../ResourceFile/hero0.png";
	inline static const std::string hero1Name = "../ResourceFile/hero1.png";
	inline static const std::string hero2Name = "../ResourceFile/hero2.png";
	inline static const std::string hero3Name = "../ResourceFile/hero3.png";
	inline static const std::string hero4Name = "../ResourceFile/hero4.png";
